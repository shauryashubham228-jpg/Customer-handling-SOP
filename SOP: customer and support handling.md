...
Quick reference for support agents to verify available options for customers.
...
> 
> 
> **Strategy:** Always encourage Store Credit for returns to reduce cash outflow and increase customer lifetime value.
> 
...
- **Security:** Credits are non-transferable and strictly linked to the account email.
...
- [ ]  **Data Privacy:** Cardholder names and details are encrypted via SHA-256.
...
> 
> 
> **Bank Holds:** If money is deducted but the order fails, it is a temporary Bank Hold. Lagorii does not have the funds yet. The bank will auto-reverse this in **3-7 business days**.
> 
> **Action:** Advise customer to check with their bank; **do not** manually confirm the order.
> 
...
COD is restricted to prevent logistics loss. It is automatically disabled for users with:

1. **Repeated delivery rejections** at the doorstep.
2. **Return rates exceeding 40%** of total order history.

**Support Script:** *"To maintain our service standards, your account is currently eligible for prepaid orders only."*

---

### 🛠 5. Transaction Flow Logic
...
graph TD
    ...
    Risk -- High Returns/RTO --> Block[Prepaid Only]
    Risk -- Clean --> Confirm
```

---

**Internal Note:** Ensure all support agents are trained on the "Bank Hold" explanation, as this is the primary source of ticket escalation. If a reversal exceeds 7 days, escalate to the **Finance - Payments** Slack channel.
